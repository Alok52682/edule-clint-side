...
const AboutSection = () => {
    return (
        <div className='text-center my-10 w-10/12 mx-auto'>
            <h2 className='text-5xl font-bold leading-tight'>Let the journey of organizing <br /> your own learning begin</h2>
            <p className='text-xl mt-3'>Go to the section of your choice to learn anything on any subject</p>
            <div className='grid grid-cols-2 gap-5 mt-6'>
                <div className="card card-side bg-base-100 border p-5">
                    <div className='p-6'>
                    ...
                    <div className="card-body text-start relative text-slate-500">
                        <h2 className="text-2xl font-semibold">It Related Classes</h2>
                ...
                <div className="card card-side bg-base-100 border p-5">
                    ...
                    <div className="card-body text-start relative text-slate-500">
                        <h2 className="text-2xl font-semibold">Addmission Test</h2>
                ...
                <div className="card card-side bg-base-100 border p-5">
                    ...
                    <div className="card-body text-start relative text-slate-500">
                        <h2 className="text-2xl font-semibold">Job Preparation</h2>
